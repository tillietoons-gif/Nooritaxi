...
export class TripsService {
  ...
  async createRide(data: any) {
    ...
    const { ride, matchedDriverTokens } = await this.prisma.$transaction(
      async (tx) => {
        // Optimization: Parallelize independent ride creation and driver matching
        ...
        // Optimization: Parallelize subsequent trip update, driver status update, and notification fetching
