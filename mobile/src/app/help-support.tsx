...
const FAQS = [
  ...
  { question: 'How do I pay for my trip or order?', answer: 'Pay your driver, courier, or merchant partner in cash when the service is completed.' },
  { question: 'Can I use digital payments right now?', answer: 'Not at the moment. The app currently supports cash payments only.' },
...
export default withSessionGuard(HelpSupportScreen);
