...
function LoginPageContent() {
  ...
  const resolvedMessage = message || (accessReason === WEB_MOBILE_ONLY_REASON ? t("login.error_drivers", "Drivers must sign in through the mobile app.") : "")
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (!response.ok) {
        setMessage(data.message ?? t("login.error_failed", "Authentication failed. Please verify your credentials."))
        return
      }

      if (!canAccessWebPortal(data.user?.role)) {
        clearSession()
        setMessage(t("login.error_drivers", "Drivers must sign in through the mobile app."))
        return
      }
      ...
      >
        ...
        <GlassSurface variant="premium" className="p-8 md:p-12 bento-shadow border-none">
          <div className="flex flex-col items-center mb-10 text-center">
            ...
            <HeadingMd className="mb-2 font-black">{t("login.title", "Authorized Access")}</HeadingMd>
          ...
          <form onSubmit={submit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  placeholder={t("login.phone_placeholder", "+93 7XX XXX XXX")}
                  required
                  aria-required="true"
            ...
            >
              ...
              ) : t("login.initialize", "Initialize Access")}
            </Button>
          </form>
